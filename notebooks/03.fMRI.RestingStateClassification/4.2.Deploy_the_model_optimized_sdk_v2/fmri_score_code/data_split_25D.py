...
def split_data(data_dir, directory_label):
    ...
    #
    all_indices = list(range(176))
    tt, test_indices = train_test_split(all_indices, test_size=0.20, shuffle = True, random_state=42)
    train_indices, valid_indices = train_test_split(tt, test_size=0.10,shuffle = True, random_state= 42)
